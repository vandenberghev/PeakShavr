...
from .load_subentry import infer_expected_source_mode
...
class LoadConfig:
    ...
    expected_source_mode: str = LOAD_EXPECTED_SOURCE_SENSOR
    ...
    def from_mapping(cls, data: dict[str, Any]) -> "LoadConfig":
        ...
        return cls(
            ...
            manual_expected_kw=manual_expected_kw,
            expected_source_mode=infer_expected_source_mode(
                data.get(CONF_LOAD_EXPECTED_SOURCE_MODE),
                power_sensor=power_sensor,
                manual_expected_kw=manual_expected_kw,
            ),
            min_required_kw=(
    ...
    def as_mapping(self) -> dict[str, Any]:
        ...
        return {
            ...
            CONF_LOAD_EXPECTED_SOURCE_MODE: self.expected_source_mode,
